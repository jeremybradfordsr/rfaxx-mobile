...
void main() => runApp(MaterialApp(home: RFaxxExplorer()));

class RFaxxExplorer extends StatefulWidget {
  @override
  _RFaxxExplorerState createState() => _RFaxxExplorerState();
}

class _RFaxxExplorerState extends State<RFaxxExplorer> {
          ...
          return FloatingActionButton(
            onPressed: () async {
              ...
              Scaffold.of(context).showSnackBar(
                SnackBar(content: Text('Saved $url for later.')),
              );
            },
        ...
        return PopupMenuButton<String>(
          onSelected: (String value) async {
            if (value == 'Email link') {
              var url = await controller.data.currentUrl();
              await launch(
                  'mailto:?subject=Check out this =$url');
            } else {
